...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-f0ca&d55jj7dz26p7epw2-9bu!698euxx@*sj%b!bpw7t+^d%r')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'messaging.context_processors.unread_notifications_count',
            ],
        },
    },
]
...
# Media uploads - Force Cloudinary everywhere
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': os.environ.get('CLOUDINARY_CLOUD_NAME', 'demo'),
    'API_KEY': os.environ.get('CLOUDINARY_API_KEY', '123456789012345'),
    'API_SECRET': os.environ.get('CLOUDINARY_API_SECRET', 'abcdefghijklmnopqrstuvwxyz123456'),
}
